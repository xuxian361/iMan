...
public class PostItemMenuPopup extends PopupWindow implements View.OnClickListener {
    ...
    public PostItemMenuPopup(Context context) {
        super(context);
    ...
    private void initPopup() {
        view = LayoutInflater.from(mContext).inflate(R.layout.popup_post_item_menu, null);
        view.measure(View.MeasureSpec.UNSPECIFIED, View.MeasureSpec.UNSPECIFIED);

        ImageView iv_arrow_up = (ImageView) view.findViewById(R.id.iv_arrow_up);
        ...
        ImageView iv_arrow_down = (ImageView) view.findViewById(R.id.iv_arrow_down);

        RelativeLayout rel_report = (RelativeLayout) view.findViewById(R.id.rel_report);
